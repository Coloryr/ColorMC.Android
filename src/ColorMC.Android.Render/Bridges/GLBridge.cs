...
//        if (!EGL.Initialize(_eglDisplay, (int*)0, (int*)0))
//        {
//            RenderLog.Error(_logTag, $"eglInitialize_p() failed: {EGL.GetError():04x}");
//            return false;
//        }
...
//        {
//            if (EGL.ChooseConfig(_eglDisplay, ptr, (EGLConfig*)0, 0, &num_configs) != 1)
//            {
//                RenderLog.Error(_logTag, $"eglChooseConfig_p() failed:{EGL.GetError():04x}");
//                return null;
//            }
//            if (num_configs == 0)
//            {
...
//            EGLConfig config;
//            EGL.ChooseConfig(_eglDisplay, ptr, &config, 1, &num_configs);
//            bundle.config = config;
//            int format;
//            EGL.GetConfigAttrib(_eglDisplay, bundle.config, 0x302E, &format);
...
//                bindResult = EGL.BindAPI(0x30A2);
//            }
//            else 
//            {
//                RenderLog.Info(_logTag, "EGLBridge: Binding to OpenGL ES");
//                bindResult = EGL.BindAPI(0x30A0);
//            }
//            if (bindResult == 0)
//            {
//                RenderLog.Error(_logTag, $"EGLBridge: bind failed: {EGL.GetError():04x}");
//            }
//        }
...
//        bundle.context = EGL.CreateContext(_eglDisplay, bundle.config, share == null ? 0 : share.context, ptr);

//        if (bundle.context == 0)
//        {
//            RenderLog.Error(_logTag, $"eglCreateContext_p() finished with error: {EGL.GetError():04x}");
//            return null;
//        }
//        return bundle;
//    }
...
//        }
//        if (bundle.surface != 0) EGL.DestroySurface(_eglDisplay, bundle.surface);
...
//            bundle.surface = EGL.CreateWindowSurface(_eglDisplay, bundle.config, bundle.NativeSurface, (int*)0);
//        }
//        else
//        {
...
//            bundle.surface = EGL.CreatePbufferSurface(_eglDisplay, bundle.config, ptr);
//        }
//    }
...
//        if (bundle == null)
//        {
//            if (EGL.MakeCurrent(_eglDisplay, 0, 0, 0) != 0)
//            {
//                _currentBundle = null;
//            }
//            return;
...
//        }
//        if (EGL.MakeCurrent(_eglDisplay, bundle.surface, bundle.surface, bundle.context) != 0)
//        {
...
//            }
//            RenderLog.Error(_logTag, $"eglMakeCurrent returned with error: {EGL.GetError():04x}");
//        }
//    }
...
//        {
//            EGL.MakeCurrent(_eglDisplay, 0, 0, 0); //detach everything to destroy the old EGLSurface
//            GLSwapSurface(_currentBundle);
//            EGL.MakeCurrent(_eglDisplay, _currentBundle.surface, _currentBundle.surface, _currentBundle.context);
//            _currentBundle.State = STATE_RENDERER.ALIVE;
//        }
//        if (_currentBundle.surface != 0)
//            if (EGL.SwapBuffers(_eglDisplay, _currentBundle.surface) != 0 && EGL.GetError() == 0x300D)
//            {
//                EGL.MakeCurrent(_eglDisplay, 0, 0, 0);
