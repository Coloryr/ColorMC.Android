...
public class GLFW
{
    ...
    public static String libSo = "libcolormcnative_run.so";
    public static String libName = "colormcnative_run";

    static {
        String windowWidth = System.getenv(PROP_WINDOW_WIDTH);
        String windowHeight = System.getenv(PROP_WINDOW_HEIGHT);
    ...
    private static final SharedLibrary GLFW = Library.loadNative(GLFW.class, "org.lwjgl.glfw", libSo, true);
    ...
    public static final class Functions {
        ...
        DestroyContext = apiGetFunctionAddress(GLFW, "colormcDestroyContext"),
        ...
        RewindEvents = apiGetFunctionAddress(GLFW, "colormcRewindEvents"),
        SetupEvents = apiGetFunctionAddress(GLFW, "colormcComputeEventTarget");
    }
    ...
    public static void glfwDestroyContext(@NativeType("GLFWwindow *") long window) {
